...
if (isset($_GET['deleteNIS'])) {
    ...
    $delete = mysqli_query($koneksi_db, "DELETE FROM siswa WHERE NIS='$deleteNIS'");
        ...
        <div class="card mx-auto" style="max-width: 400px;">
            <div class="card-body">
                ...
                <form action="" method="get">
                    <div class="mb-3">
                        <label for="deleteNIS" class="form-label">NIS</label>
                        <input type="number" name="deleteNIS" id="deleteNIS" placeholder="Masukkan NIS"
                            class="form-control">
                    </div>
